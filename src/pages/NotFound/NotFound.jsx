...
const NotFound = () => {
  return (
    <div className="h-screen w-full flex flex-col md:flex-row items-center justify-center">
      <h1 className="text-[8rem] font-bold text-primary animate-bounce text-pink-600">404</h1>
      ...
      <div className="flex flex-col items-center">
        ...
        <Link to="/">
          <button className="bg-pink-600 rounded-full p-2 hover:bg-neutral-50 hover:text-pink-600">
